...
class CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.pool = nn.MaxPool2d(2, 2)  # pooling layer function
...
class NNModel:
    ...
    def view_batch(self):
        ...
        # print(images.size())
        # The image size is (64, 1, 28, 28)
        images_out = images.view(8, 8, 28, 28).permute(0, 2, 1, 3).reshape(28*8, 28*8)
    ...
    def train_step(self):
        """
        Used for submission tests and may be useful for debugging
        DO NOT MODIFY
        """
        self.model.train()
